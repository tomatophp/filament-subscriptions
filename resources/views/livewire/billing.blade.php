                        ...
                        <div class="px-6 py-4 bg-gray-100 bg-opacity-50 border-t border-gray-100 text-right">
                            ...
                            @if ($hasSubscription)
                                @if ($hasSubscription->plan_id === $plan->id)
                                    ...
                                    @else
                                        <button wire:click="subscribe({{ $plan->id }})" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
